            ...
            <div className="mt-8">
              <div className="flow-root">
                <ul role="list" className="-my-6 divide-y divide-gray-200">
                  ...
                  {productsInCart.length === 0 && <div>No items in cart</div>}
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
            ...
            <div className="mt-6">
              ...
              {!productsInCart.length && (
                <a
                  href="#"
                  className="flex items-center justify-center rounded-md border border-transparent pointer-events-none bg-gray-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                >
                  Checkout
                </a>
              )}
